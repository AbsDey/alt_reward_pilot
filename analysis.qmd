...
![Note. We take the difference between incongruent and congruent z-scored RTs. Values above the the dashed line indicate a (positive) Stroop effect. Values below the dashed line indicate a reverse (negative) Stroop effect.](stroop_series.svg){.lightbox}
