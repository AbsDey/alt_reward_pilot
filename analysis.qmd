...
data_path <- "C:/Users/deyne/Desktop/ARS pilot/"
...
### Reward Type x Congruency (collapsed blocks): RT
...
### Reward Type x Congruency (collapsed blocks): Errors
...
### Rewarded Color (across cycles) x Reward Block x Congruency: RT
...
### Distractor Identity Rewarded (across cycles) x Reward Block x Congruency: RT
...
![Note. We z-scored within participants since a participant can only encounter either a congurent or incongruent stimuli for each trial a reward was available. Because we cannot take a within person difference at each trial number, this allows for a more representative comparison between reward and no reward block RTs.](rewarded_color_series.svg){.lightbox}

<br>

![Note. We take the difference between incongruent and congruent z-scored RTs.](stroop_series.svg){.lightbox}
